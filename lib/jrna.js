...
@macro cbormethod name args when
...
function jRna () {
    ...
    *
    *   @cbormethod callback clickEvent "when the element is clicked"
    ...
    *       A jrna-prefixed class in the DOM
    *   @end id
    *   @cbormethod callbackOn clickEvent "on 1st, 3rd, etc clicks"
    ...
    *       plus some additional values to be prepended to the argument list.
    *   @end cbormethod
    *   @cbormethod callbackOff clickEvent "on every second click"
    ...
    *  @cbormethod  callback clickEvent " on click, provided that the lock property is false"
    *      @param {function|string|Array} callback
    ...
    *       A jrna-prefixed class in the DOM
    *   @end id
    *   @cbormethod callback event "whenever event is triggered on <tt>receptor</tt> element"
    *       @param {function|string|Array} callback
    ...
    */
    ...
    this.spawn = function( args ) {
        ...
        if (!this._master)
            blame('Trying to spawn with an empty html()');
