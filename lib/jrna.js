...
@macro callback arg
    @param {function|string|Array} callback($(arg))
    Run this code with the jRna instance as this.
    A string means use a method with that name.
    An Array must contain any of the above
    plus some additional arguments to be passed to the function.
@end callback
...
function jRna () {
    ...
    *   @callback event
    *       @param {function|string|Array} callback(event)
    *       Run this code with the jRna instance as this.
    *       A string means use a method with that name.
    *       An Array must contain any of the above
    *       plus some additional arguments to be passed to the function.
