...
*   one of {@link jRna#attach attach}, {@link jRna#appendTo}, or {@link jRna#spawn} calls.
*
*   @constructor
*   @this {jRna}
*/
function jRna () {
    ...
    /**
    *  Set default HTML snippet to attach to
    *
    *  @function html
    *  @memberOf jRna
    *  @instance
    *  @param {string} html - A HTML snippet with one root node
    *  @returns {jRna} 
    */
    ...
    *  @memberOf jRna
    *  @instance
    *  @param {string|jQuery} selector - where to search for root element
    *  @returns {jRna}
    */
    ...
    /**
    *  Specify one or more optional arguments
    *  for {@link #attach}, {@link #appendTo}, and {@link #spawn} calls.
    *  May be called more than once.
    *
    *  @function args
    *  @memberOf jRna
    *  @instance
    *  @returns {jRna} chainable
